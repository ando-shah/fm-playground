...
all_tasks=(
    ...
    # 'base/panopticon_chnsim linear_probe hyperview_sd 200'
    # 'base/panopticon_chnsim linear_probe hyperview_modis 150'
    ...
    # 'base/panopticon_chnsim linear_probe geobench_pv4ger_cls 400'

    'base/panopticon_chnsim linear_probe benv2_s1 400'
    'base/panopticon_chnsim linear_probe benv2_s2_12b 200'
    'base/panopticon_chnsim linear_probe fmow_8b 200'
    'base/panopticon_chnsim linear_probe fmow_rgb 400'
    'base/panopticon_chnsim linear_probe geobench_brick_kiln_13b 200'

    'base/panopticon_chnsim linear_probe digital_typhoon_3b 200'
    'base/panopticon_chnsim linear_probe tropical_cyclone 1000'
